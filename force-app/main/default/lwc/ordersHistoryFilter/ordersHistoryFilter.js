...
export default class OrdersHistoryFilter extends LightningElement {
    ...
    handleStatusChange(event) {
        ...
        const selectedEvent = new CustomEvent('statuschange', {detail: this.selectedStatus});
        this.dispatchEvent(selectedEvent);
    }

    handleDateChange(event) {
        this.selectedDate = event.target.value;
        const selectedEvent = new CustomEvent('datechange', {detail: this.selectedDate});
        this.dispatchEvent(selectedEvent);
    }

    handleDishChange(event) {
        this.selectedDish = event.target.value;
        const selectedEvent = new CustomEvent('dishchange', {detail: this.selectedDish});
        this.dispatchEvent(selectedEvent);
    }
